<template>
  <main>
    <h1>Nuxt SSR of RHDS Elements</h1>
    <h2>SSR supporting Elements</h2>
    <div class="grid xs-two-columns">
      <rh-cta href="#some-link">Hello world</rh-cta>
    ...
    <h3>known issue: ::slotted element on server side</h3>
    <div class="grid xs-two-columns">
    ...
    <h2>Elements with no SSR support</h2>
    <p>* support coming in RHDS 2.1 Clefairy</p>
    <div class="grid xs-two-columns">
  ...
  <rh-transcript id="regular" slot="transcript">
    ...
    <div>
      <h2>Epic fail</h2>
      <h3>Even with tags ignored cause errors in nuxt...</h3>
      <ul>
        <li>Audio player</li>
        <li>Subnav</li>
      </ul>
...
<script type="module">
  ...
  import '@rhds/icons/ui/caret-left.js'
  import '@rhds/icons/ui/caret-right.js'
  import '@rhds/icons/ui/arrow-left.js'
  import '@rhds/icons/ui/arrow-right.js'
</script>
...
<script setup>
  useHead({
    ...
    link: [
      {
        rel: 'stylesheet',
        href: '/styles/elements/rh-tile/rh-tile-lightdom.css'
      },
      {
        rel: 'stylesheet',
        href: '/styles/elements/rh-pagination/rh-pagination-lightdom.css'
      },
      {
        rel: 'stylesheet',
        href: 'https://ux.redhat.com/assets/packages/@rhds/tokens/css/global.css'
      },      
      {
        rel: 'stylesheet',
        href: 'https://ux.redhat.com/styles/reset.css'
      },
      {
        rel: 'stylesheet',
        href: 'https://ux.redhat.com/styles/fonts.css'
      },
      {
        rel: 'stylesheet',
        href: 'https://ux.redhat.com/styles/typography.css'
      }, 
      {
        rel: 'stylesheet',
        href: 'https://ux.redhat.com/styles/grid.css'
      },
      {
        rel: 'stylesheet',
